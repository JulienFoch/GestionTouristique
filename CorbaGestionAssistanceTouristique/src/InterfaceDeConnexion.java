...
public class InterfaceDeConnexion extends JFrame {
	...
	public InterfaceDeConnexion() {
		...
		contentPane.add(btnConnexion, "8, 8, left, default");
		
		JLabel lblIdentifiant = new JLabel("Identifiant : ");
		contentPane.add(lblIdentifiant, "8, 12");
		
		textFieldIdentifiant = new JTextField();
		contentPane.add(textFieldIdentifiant, "14, 12, fill, default");
		textFieldIdentifiant.setColumns(10);
		
		JLabel lblMotDePasse = new JLabel("Mot de passe : ");
		contentPane.add(lblMotDePasse, "8, 16");
		
		textFieldMotDePasse = new JTextField();
		contentPane.add(textFieldMotDePasse, "14, 16, fill, default");
